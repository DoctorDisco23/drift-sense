...
│  │ • Krish (Algorithmic Lead): Preprocessing (CLAHE), Multi-Scale     │  │
...
**Speaker Notes**:
> *"Welcome everyone. Today we present Drift-Sense—an advanced, sub-pixel navigation-error recovery system for semiconductor wafer inspection tools. This deck details our algorithmic architectur[...]
...
**Speaker Notes**:
> *"In wafer steppers, physical positioning errors occur due to mechanical hysteresis and thermal shifts. Furthermore, silicon wafer dies contain highly repetitive memory cell grids that cause sta[...]
